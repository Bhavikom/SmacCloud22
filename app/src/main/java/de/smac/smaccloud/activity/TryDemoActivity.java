                    ...
                    else
                    {
                        ...
                        if (userPreference.userId == -1)
                        {
                            ...
                            postNetworkRequest(REQUEST_SYNC, DataProvider.ENDPOINT_SYNC, DataProvider.Actions.SYNC,
                                    ...
                                    RequestParameter.urlEncoded("UserId", String.valueOf(user.id)), RequestParameter.urlEncoded("LastSyncDate", lastSyncDate), RequestParameter.urlEncoded("Org_Id", PreferenceHelper.getOrganizationId(context)), RequestParameter.urlEncoded("DeviceId", PreferenceHelper.getFCMTokenId(context)));
